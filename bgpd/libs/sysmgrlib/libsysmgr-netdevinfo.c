 ...
 *   p4p1: 1369039   16254    0    0    0     0          0         0      662       9    0    0    0     0       0          0
 */
...
int sys_netdevinfo_get(sys_netdevinfo_t ** pnetdevinfos)
{
    ...
    while (fgets(buf, sizeof(buf), fp)) {
        ...
        *q = '\0';
        ...
        if (sscanf(p, PROC_NETDEV_FMT, &netdevinfo->rx_bytes, &netdevinfo->rx_packets, &netdevinfo->rx_errors,
                    ...
                    &netdevinfo->tx_fifo_errors, &netdevinfo->collisions, &netdevinfo->tx_carrier_errors, &netdevinfo->tx_compressed) != 16) {
            free(netdevinfo);
            continue;
        }
