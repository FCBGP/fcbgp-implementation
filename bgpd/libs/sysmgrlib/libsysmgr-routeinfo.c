 ...
 *  p4p1    000114AC    00000000    0001    0   0   1   00FFFFFF    0   0   0
 *  p4p1    004D000A    00000000    0001    0   0   0   00FFFFFF    0   0   0
...
int sys_routeinfo_get(sys_routeinfo_t ** prouteinfos, int flags)
{
    ...
    while (fgets(buf, sizeof(buf), fp)) {
        ...
        if (sscanf(buf, PROC_NETROUTE_FMT, routeinfo->ifname, dest, gway,
                    ...
                    &routeinfo->rt_metric, mask, &routeinfo->rt_mtu, &routeinfo->rt_window,
                    &routeinfo->rt_irtt) != 11) {
            free(routeinfo);
            continue;
        }
