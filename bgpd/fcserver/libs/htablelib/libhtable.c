...
int htbl_meta_deleteall(htbl_ctx_t *ctx, void *meta, int (*cmp)(void *hobj, void *meta))
{
    int i = 0;
    int cnt = 0;
    htbl_node_t *hobj = NULL;
...
void htbl_foreach(htbl_ctx_t *ctx, int (*handler)(htbl_ctx_t *ctx, void *node, void *arg), void *arg)
{
    int i;
    struct hlist_node *pos;
    htbl_node_t *hobj = NULL;
