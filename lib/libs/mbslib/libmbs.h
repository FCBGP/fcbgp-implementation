...
extern mbs_t mbscatns(mbs_t *pmbs, uint16_t hs); // catenate a host short number as network short number
extern mbs_t mbscatnl(mbs_t *pmbs, uint32_t hl); // catenate a host long number as network long nubmer
extern mbs_t mbscatnll(mbs_t *pmbs, uint64_t hll); // catenate a host long long number as network long long number
