...
extern int ncs6_sock_connect(int fd, struct sockaddr_in6 *addr, socklen_t len, int timeout);
extern int ncs6_sock_accept(int fd, struct sockaddr_in6 *addr, socklen_t *len, int timeout);
extern int ncs6_sock_send(int fd, void *data, int count, int *sent, int timeout);
extern int ncs6_sock_sendto(int fd, void *data, int count, int *sent, struct sockaddr_in6 *addr, socklen_t len, int timeout);
extern int ncs6_sock_recv(int fd, void *data, int count, int *got, int timeout);
extern int ncs6_sock_recvfrom(int fd, void *data, int count, int *got, struct sockaddr_in6 *addr, socklen_t *len, int timeout);
extern int ncs6_buffer_send(int fd, void *data, int count, int *sent, int timeout);
extern int ncs6_buffer_recv(int fd, void *data, int count, int *got, int timeout);
...
extern int ncs6_setup(ncs6_ctx_t *ctx, char *local_addr, uint16_t local_port, char *remote_addr, uint16_t remote_port);
...
extern int ncs6_server_register(ncs6_ctx_t *ctx, int (*server_handler)(struct ncs6_ctx_st *ctx));
