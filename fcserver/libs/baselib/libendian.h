 ...
 */
#define endian_swahw64(x)                                                      \
    ((uint64_t)((((uint64_t)(x) & (uint64_t)0x00000000ffffffffULL) << 32) |    \
...
static inline void endian_memcpy_ntohl(unsigned char* dst, unsigned char* src,
                                       int len)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
    int i = 0;
...
static inline void endian_memcpy_htonl(unsigned char* dst, unsigned char* src,
                                       int len)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
    int i = 0;
...
static inline void endian_memcpy_ntohll(unsigned char* dst, unsigned char* src,
                                        int len)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
    int i = 0;
...
static inline void endian_memcpy_htonll(unsigned char* dst, unsigned char* src,
                                        int len)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
    int i = 0;
...
static inline void endian_memcpy_swahw64(unsigned char* dst, unsigned char* src,
                                         int len)
{
    int i = 0;
    int max = len / 8;
