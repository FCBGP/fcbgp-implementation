 ...
 */
static inline void my_list_add(struct list_head* node, struct list_head* head)
{
...
#define fifo_dump(fp, fifo, data_dump, adjust)                                 \
    slist_dump(fp, fifo, data_dump, adjust)
#define fifo_empty(fifo) slist_empty(fifo)
#define fifo_enqueue(fifo, value) slist_add_tail(fifo, value)
#define fifo_enqueue_exclusive(fifo, value, cmp)                               \
    slist_add_tail_exclusive(fifo, value, cmp)
...
#define filo_dump(fp, filo, data_dump, adjust)                                 \
    slist_dump(fp, filo, data_dump, adjust)
#define filo_empty(filo) slist_empty(filo)
#define filo_enqueue(filo, value) slist_add(filo, value)
#define filo_enqueue_exclusive(filo, value, cmp)                               \
    slist_add_exclusive(filo, value, cmp)
