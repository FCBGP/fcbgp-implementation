...
int demo_meta_cmp(void* base, void* meta)
{
    ...
    if (bobj->depth == mobj->depth && bobj->width == mobj->width &&
...
int main(int argc, char* argv[])
{
    ...
    printf("htbl_init return %d ptr size %d spinlock size %d atomic size %d "
           "hlist size %d rwlock size %d hnode size %d node size %d\n",
           ret, (int)sizeof(void*), (int)sizeof(spinlock_t),
           (int)sizeof(atomic_t), (int)sizeof(htbl_hlist_t),
           (int)sizeof(rwlock_t), (int)sizeof(htbl_node_t),
           (int)sizeof(demo_node_t));
