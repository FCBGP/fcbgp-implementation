...
int sys_temperature_get(void)
{
    ...
    tempinfo = strappendstdout(&tempinfo, "cat /sys/class/hwmon/hwmon0/device/temp1_input");
    if (tempinfo) {
...
int sys_route_add(char *ipaddr_str, char *netmask_str, char *gwaddr_str)
{
    ...
    mbscatfmt(&cmdline, "route add -net  \"%u.%u.%u.%u\" netmask ",
            ipaddr.u.addr8[0], ipaddr.u.addr8[1],
            ipaddr.u.addr8[2], ipaddr.u.addr8[3]);
    ...
    mbscatfmt(&cmdline, "%u.%u.%u.%u gw %u.%u.%u.%u",
            netmask.u.addr8[0], netmask.u.addr8[1],
            netmask.u.addr8[2], netmask.u.addr8[3],
            gwaddr.u.addr8[0], gwaddr.u.addr8[1],
            gwaddr.u.addr8[2],gwaddr.u.addr8[3]);
