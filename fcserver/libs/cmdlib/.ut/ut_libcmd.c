...
int do_process(app_t* app, cmdline_t* cmdline)
{
    ...
    while (arg4)
    {
        printf("arg4=" ETHADDRFMT "\n", arg4->mac[0], arg4->mac[1],
               arg4->mac[2], arg4->mac[3], arg4->mac[4], arg4->mac[5]);
...
int main(int argc, char** argv)
{
    ...
    app_t* app = app_create("democmd", PRJ_VERSION, PRJ_COPYRIGHT,
                            "zhouxy<zhouxy314@163.com>,"
                            "liaoxf<liaofei1128@163.com>",
                            "democmd is a program to show how to use libcmd.");

    app_add_ptype(app, "date", sizeof(var_date_t), (ptype_parser_t)parse_date,
                  "a date in format yyyy/mm/dd or yyyy-mm-dd");

    app_add_option(app, '0', "arg0", "int", 0, "arg0 with an int value");
    app_add_option(app, '1', "arg1", "string", 0, "arg1 with a string value");
    app_add_option(app, '2', "arg2", "ipaddr4", 0,
                   "arg2 with an ipaddr4 value");
    app_add_option(app, '3', "arg3", NULL, 0, "arg3 with none value");
    app_add_option(app, '4', "arg4", "ethaddr", 1,
                   "arg4 with ethaddr value repeatable");
    app_add_option(app, '5', "arg5", "cidraddr4", 0,
                   "arg5 with cidraddr4 value");
    ...
    app_add_option(app, -1, "argx", "uint16", 0,
                   "argx with unsigned 16 bits integer value");

    app_add_option(app, 'C', "process", NULL, 0, "process option to action");

    app_add_cmdline(app, "process,arg0,arg1,[arg2,arg3,arg4],arg5", do_process,
                    "process something with a lot of arguments.");
